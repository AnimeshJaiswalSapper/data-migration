...
public class DataMigrationService {
    ...
    private static final List<String> MODELS = List.of("AuditEntity","AuditSnapshot","AuditSnapshotOriginal","Case","CaseDocumentDO","COA","COALabel","Config","SapperRule","Status");
